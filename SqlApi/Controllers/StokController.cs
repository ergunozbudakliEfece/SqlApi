...
namespace SqlApi.Controllers
{
    ...
    public class StokController : ControllerBase
    {
        ...
        public JsonResult GetGruplar()
        {
            ...
            string query = @"SELECT GRUP_KOD,EFECE2023.DBO.TRK(GRUP_ISIM) AS GRUP_ISIM FROM EFECE2023..TBLSTGRUP WHERE GRUP_ISIM IS NOT NULL AND GRUP_KOD IN(SELECT DISTINCT(GRUP_KODU) FROM EFECE2023..TBLSTSABIT ST INNER JOIN EFECE2023..TBLSTHAR AS HAR WITH (NOLOCK) ON HAR.STOK_KODU = ST.STOK_KODU AND HAR.DEPO_KODU IN (1, 5, 8, 45) WHERE GRUP_KODU IS NOT NULL) AND GRUP_KOD NOT IN('0137','0135','0006') ORDER BY EFECE2023.DBO.TRK(GRUP_ISIM)";
